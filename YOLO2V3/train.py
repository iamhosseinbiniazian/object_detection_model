...
def create_model(input_shape, anchors, num_classes, load_pretrained=True, freeze_body=2,
    ...
    infer_model=Model([model_body.input],*model_body.output)
...
def _main_(args):
    ...
    if is_tiny_version:
        train_model, infer_model = create_tiny_model(input_shape, anchors, num_classes,
                                  freeze_body=2, weights_path=weights_path)
    else:
        train_model, infer_model = create_model(input_shape, anchors, num_classes,
                             freeze_body=2,
    ...
    if True:
        ...
        batch_size = 32
        num_train=len(train_ints)
        num_val=len(valid_ints)
